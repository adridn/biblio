...
{
    [Authorize]
    public class Type_AuteurController : Controller
    {
        ...
        // GET: Type_Auteur/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Type_Auteur/Create
